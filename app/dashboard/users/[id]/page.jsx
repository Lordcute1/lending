    ...
    <div className={styles.container}>
      <div className={styles.infoContainer}>
        <div className={styles.imgContainer}>
          <Image src={admin.img || "/astronaut.png"} alt="" fill />
        </div>
        {admin.username}
      </div>
      <div className={styles.formContainer}>
        <form action={updateUser} className={styles.form}>
          ...
          <select name="isAdmin" id="isAdmin">
            <option value={true} selected={admin.isAdmin}>
              Yes
            </option>
            <option value={false} selected={!admin.isAdmin}>
              No
            </option>
          </select>
          <label>Is Active?</label>
          <select name="isActive" id="isActive">
            <option value={true} selected={admin.isActive}>
              Yes
            </option>
            <option value={false} selected={!admin.isActive}>
              No
            </option>
          </select>
